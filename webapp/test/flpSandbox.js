		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP Marina",
									"targetURL": "#marinamarina-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"marinamarina-display": {
								"semanticObject": "marinamarina",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=marina",
									"url": sap.ui.require.toUrl("marina")
								}
							}
						}
					}
